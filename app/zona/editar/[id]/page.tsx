...
export default function EditarZonaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({
        ...errors,
        nombre: "Ocurrió un error al actualizar la zona. Por favor, intente nuevamente.",
      })
    } finally {
  ...
  return (
    <div className="bg-[#f4f6fb] min-h-screen">
      <div className="pl-8 pr-6 py-6 max-w-[1200px]">
        ...
        <p className="text-gray-600 mb-8">Edita la zona seleccionada.</p>
